...
<sld:Rule>
    <ogc:Filter>
    <ogc:Or>
        <ogc:PropertyIsEqualTo><ogc:PropertyName>adm0_a3</ogc:PropertyName><ogc:Literal>USA</ogc:Literal></ogc:PropertyIsEqualTo>
        <ogc:PropertyIsEqualTo><ogc:PropertyName>adm0_a3</ogc:PropertyName><ogc:Literal>CAN</ogc:Literal></ogc:PropertyIsEqualTo>
        <ogc:PropertyIsEqualTo><ogc:PropertyName>adm0_a3</ogc:PropertyName><ogc:Literal>DEU</ogc:Literal></ogc:PropertyIsEqualTo>
    </ogc:Or>
    </ogc:Filter>
<sld:MinScaleDenominator>9244649</sld:MinScaleDenominator>
<sld:MaxScaleDenominator>73957193</sld:MaxScaleDenominator>
              <sld:LineSymbolizer>
                    <sld:Stroke><sld:CssParameter name="stroke">#<ogc:Function name="env"><ogc:Literal>boundary_dark</ogc:Literal><ogc:Literal>&boundary_dark;</ogc:Literal></ogc:Function></sld:CssParameter><sld:CssParameter name="stroke-width">0.3</sld:CssParameter><sld:CssParameter name="opacity">1</sld:CssParameter>
                        <CssParameter name="stroke-dasharray">5 5</CssParameter><sld:CssParameter name="stroke-linejoin">round</sld:CssParameter><sld:CssParameter name="stroke-linecap">round</sld:CssParameter></sld:Stroke>
              </sld:LineSymbolizer>
