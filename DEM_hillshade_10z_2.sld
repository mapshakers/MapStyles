...
<ogc:PropertyIsNotEqualTo>
     <ogc:Function name="strMatches"><ogc:Function name="env"><ogc:Literal>render</ogc:Literal><ogc:Literal>&render;</ogc:Literal></ogc:Function><ogc:Literal>.*hillshade-2.*</ogc:Literal>		</ogc:Function><ogc:Literal>false</ogc:Literal>
</ogc:PropertyIsNotEqualTo>
</ogc:Filter>  
  -->
  <!-- from 6 to 9  zoom -->
<RasterSymbolizer>
     ...
     <VendorOption name="composite">multiply,0.8</VendorOption>
  </FeatureTypeStyle>
  </UserStyle>
  </NamedLayer>
