...
<Rule> 
 <sld:MaxScaleDenominator>72223</sld:MaxScaleDenominator>
   <sld:PolygonSymbolizer>
                          <sld:Fill><sld:GraphicFill><sld:Graphic><sld:ExternalGraphic><OnlineResource xlink:type="simple" xlink:href="symbols/snow_flake.svg"/><Format>image/svg+xml</Format></sld:ExternalGraphic><sld:Size>20</sld:Size></sld:Graphic></sld:GraphicFill><CssParameter name="opacity">1</CssParameter></sld:Fill> 
   </sld:PolygonSymbolizer>
  </Rule>
</sld:FeatureTypeStyle>  
