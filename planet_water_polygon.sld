...
<sld:UserStyle>
    ...
    <sld:FeatureTypeStyle>  <!-- OCEAN from 0 to 20-->
<sld:Rule>
  
<ogc:Filter>
<ogc:And>
    <ogc:PropertyIsEqualTo><ogc:PropertyName>layer</ogc:PropertyName><ogc:Literal>oceans</ogc:Literal></ogc:PropertyIsEqualTo>
    <ogc:PropertyIsNotEqualTo><ogc:Function name="env"><ogc:Literal>water</ogc:Literal><ogc:Literal>&water;</ogc:Literal></ogc:Function><ogc:Literal>010203</ogc:Literal></ogc:PropertyIsNotEqualTo>
          ...
          <sld:PolygonSymbolizer>
                    <sld:Fill><sld:CssParameter name="fill">#<ogc:Function name="env"><ogc:Literal>water</ogc:Literal><ogc:Literal>&water;</ogc:Literal></ogc:Function></sld:CssParameter><CssParameter name="opacity">1</CssParameter></sld:Fill>
          </sld:PolygonSymbolizer>
...
<ogc:Filter>
<ogc:And>
<ogc:PropertyIsEqualTo><ogc:PropertyName>layer</ogc:PropertyName><ogc:Literal>lakes</ogc:Literal></ogc:PropertyIsEqualTo>
    <ogc:PropertyIsNotEqualTo><ogc:Function name="env"><ogc:Literal>water</ogc:Literal><ogc:Literal>&water;</ogc:Literal></ogc:Function><ogc:Literal>010203</ogc:Literal></ogc:PropertyIsNotEqualTo>
</ogc:And>
</ogc:Filter>
...
<ogc:Filter>
<ogc:And>
<ogc:PropertyIsEqualTo><ogc:PropertyName>layer</ogc:PropertyName><ogc:Literal>pools</ogc:Literal></ogc:PropertyIsEqualTo>
<ogc:PropertyIsGreaterThan><ogc:Function name="area"><ogc:PropertyName>geom</ogc:PropertyName></ogc:Function><ogc:Literal>50000000</ogc:Literal></ogc:PropertyIsGreaterThan>
    <ogc:PropertyIsNotEqualTo><ogc:Function name="env"><ogc:Literal>water</ogc:Literal><ogc:Literal>&water;</ogc:Literal></ogc:Function><ogc:Literal>010203</ogc:Literal></ogc:PropertyIsNotEqualTo>
</ogc:And>
</ogc:Filter>
...
<ogc:And>
<ogc:PropertyIsEqualTo><ogc:PropertyName>layer</ogc:PropertyName><ogc:Literal>pools</ogc:Literal></ogc:PropertyIsEqualTo>
<ogc:PropertyIsGreaterThan><ogc:Function name="area"><ogc:PropertyName>geom</ogc:PropertyName></ogc:Function><ogc:Literal>5000000</ogc:Literal></ogc:PropertyIsGreaterThan>
    <ogc:PropertyIsNotEqualTo><ogc:Function name="env"><ogc:Literal>water</ogc:Literal><ogc:Literal>&water;</ogc:Literal></ogc:Function><ogc:Literal>010203</ogc:Literal></ogc:PropertyIsNotEqualTo>
</ogc:And>
</ogc:Filter>
