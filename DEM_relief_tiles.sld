				...
				<Rule>
					...
					<RasterSymbolizer>
						...
						<ColorMap>
							...
							<ColorMapEntry color="#&dem_2;" quantity="0" opacity="0"/>
							<ColorMapEntry color="#&dem_3;" quantity="200"  opacity="0"/>
							<ColorMapEntry color="#&dem_4;" quantity="300"  opacity="0"/>
							<ColorMapEntry color="#&dem_5;" quantity="400"  opacity="0"/>
							<ColorMapEntry color="#&dem_6;" quantity="600"  opacity="0.2"/>
							<ColorMapEntry color="#&dem_7;" quantity="800"  opacity="0.5"/>
							<ColorMapEntry color="#&dem_8;" quantity="1600"  opacity="1"/>
