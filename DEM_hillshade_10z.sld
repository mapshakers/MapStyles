...
<ogc:PropertyIsNotEqualTo>
    <ogc:Function name="strMatches"><ogc:Function name="env"><ogc:Literal>render</ogc:Literal><ogc:Literal>&render;</ogc:Literal></ogc:Function><ogc:Literal>.*hillshade.*</ogc:Literal>		</ogc:Function><ogc:Literal>false</ogc:Literal>
</ogc:PropertyIsNotEqualTo>
</ogc:Filter>
...
<RasterSymbolizer>
    <!-- <ColorMap type="ramp">
         ...
         <ColorMapEntry color="#888888" quantity="10" opacity="1"/>
         <ColorMapEntry color="#000000" quantity="255" opacity="1"/>
       </ColorMap>-->
    <Opacity>0.4</Opacity>
   </RasterSymbolizer>
   </Rule>
       <VendorOption name="composite">multiply,0.9</VendorOption>
   </FeatureTypeStyle>
   </UserStyle>
   </NamedLayer>
