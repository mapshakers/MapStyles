...
<sld:NamedLayer>
<sld:Name>land polygon</sld:Name>
<sld:UserStyle>
  
 
    
<sld:FeatureTypeStyle> <!-- simplified land poylygon 0 - 9  -->
<sld:Rule>
<ogc:Filter>
<ogc:PropertyIsEqualTo><ogc:PropertyName>type</ogc:PropertyName><ogc:Literal>simplified_land_polygon</ogc:Literal></ogc:PropertyIsEqualTo>      
</ogc:Filter>
<sld:MinScaleDenominator>288895</sld:MinScaleDenominator> 
             <sld:PolygonSymbolizer>
                <!--#ADE27B-->
                            <sld:Fill><sld:CssParameter name="fill">#<ogc:Function name="env"><ogc:Literal>background</ogc:Literal><ogc:Literal>&background;</ogc:Literal></ogc:Function></sld:CssParameter><CssParameter name="opacity">1</CssParameter></sld:Fill>
                  </sld:PolygonSymbolizer>
  
</sld:Rule>
</sld:FeatureTypeStyle>  
   
<sld:FeatureTypeStyle> <!-- land poylygon  10 + -->
<sld:Rule>
<ogc:Filter>
<ogc:PropertyIsEqualTo><ogc:PropertyName>type</ogc:PropertyName><ogc:Literal>land_polygon</ogc:Literal></ogc:PropertyIsEqualTo>      
</ogc:Filter>
