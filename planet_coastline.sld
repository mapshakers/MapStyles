...
<sld:FeatureTypeStyle> <!-- coastline from 5 -->
<sld:Rule>

<sld:MaxScaleDenominator>18489298</sld:MaxScaleDenominator>
  
              <sld:LineSymbolizer>
                    <sld:Stroke><sld:CssParameter name="stroke">#<ogc:Function name="env"><ogc:Literal>water</ogc:Literal><ogc:Literal>&water;</ogc:Literal></ogc:Function></sld:CssParameter><sld:CssParameter name="stroke-width">0.25</sld:CssParameter><sld:CssParameter name="opacity">0</sld:CssParameter><sld:CssParameter name="stroke-linejoin">round</sld:CssParameter><sld:CssParameter name="stroke-linecap">round</sld:CssParameter></sld:Stroke>
              </sld:LineSymbolizer>      
