...
<sld:UserStyle>
    ...
    <FeatureTypeStyle>
        <Rule>
            <ogc:Filter>
                <ogc:PropertyIsEqualTo><ogc:PropertyName>type</ogc:PropertyName><ogc:Literal>svg</ogc:Literal></ogc:PropertyIsEqualTo>
            </ogc:Filter>


            <PointSymbolizer>
                <Graphic><ExternalGraphic><OnlineResource xlink:type="simple" xlink:href="sketch/${filename}" /><Format>image/svg+xml</Format></ExternalGraphic><Size><ogc:PropertyName>size</ogc:PropertyName></Size></Graphic>
                <VendorOption name="labelObstacle">false</VendorOption>
            </PointSymbolizer>
    ...
    <FeatureTypeStyle>
        <Rule>
            <ogc:Filter>
                <ogc:PropertyIsEqualTo><ogc:PropertyName>type</ogc:PropertyName><ogc:Literal>png</ogc:Literal></ogc:PropertyIsEqualTo>
            </ogc:Filter>


            <PointSymbolizer>
                <Graphic><ExternalGraphic><OnlineResource xlink:type="simple" xlink:href="sketch/${filename}" /><Format>image/png</Format></ExternalGraphic><Size><ogc:PropertyName>size</ogc:PropertyName></Size></Graphic>
                <VendorOption name="labelObstacle">false</VendorOption>
            </PointSymbolizer>
        </Rule>
    </FeatureTypeStyle>
    ...
    <FeatureTypeStyle>
        <Rule>
            <ogc:Filter>
                <ogc:PropertyIsEqualTo><ogc:PropertyName>type</ogc:PropertyName><ogc:Literal>jpg</ogc:Literal></ogc:PropertyIsEqualTo>
            </ogc:Filter>
            <PointSymbolizer>
                <Graphic><ExternalGraphic><OnlineResource xlink:type="simple" xlink:href="sketch/${filename}" /><Format>image/jpeg</Format></ExternalGraphic><Size><ogc:PropertyName>size</ogc:PropertyName></Size></Graphic>
                <VendorOption name="labelObstacle">false</VendorOption>

            </PointSymbolizer>

        </Rule>
        <VendorOption name="composite">multiply,1</VendorOption>
    </FeatureTypeStyle>
