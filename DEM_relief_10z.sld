				...
				<Rule>
					...
					<ogc:Filter>
						<ogc:PropertyIsNotEqualTo>
							<ogc:Function name="strMatches"><ogc:Function name="env"><ogc:Literal>render</ogc:Literal><ogc:Literal>&render;</ogc:Literal></ogc:Function>
								<ogc:Literal>.*relief.*</ogc:Literal></ogc:Function><ogc:Literal>false</ogc:Literal>
						</ogc:PropertyIsNotEqualTo>
					</ogc:Filter>
			...
			<FeatureTypeStyle>
				<Rule>
					...
					<RasterSymbolizer>
						...
						<!-- type="intervals" extended="true"-->
						<ColorMap >
							<ColorMapEntry color="#&dem_1;" quantity="-100" opacity="0"/>
							<ColorMapEntry color="#&dem_1;" quantity="0" 	opacity="0"/>
							<ColorMapEntry color="#&dem_2;" quantity="200"  opacity="0"/>
							<ColorMapEntry color="#&dem_3;" quantity="300"  opacity="0"/>
							<ColorMapEntry color="#&dem_4;" quantity="400"  opacity="0"/>
							<ColorMapEntry color="#&dem_5;" quantity="600"  opacity="0.2"/>
							<ColorMapEntry color="#&dem_6;" quantity="800"  opacity="0.5"/>
							<ColorMapEntry color="#&dem_7;" quantity="1600" opacity="1"/>
							<ColorMapEntry color="#&dem_9;" quantity="2000" opacity="1"/>
							<ColorMapEntry color="#&dem_10;" quantity="4000"  opacity="1"/>
							<ColorMapEntry color="#&dem_11;" quantity="5000"  opacity="1"/>
							<ColorMapEntry color="#&dem_12;" quantity="7000"  opacity="1"/>
						</ColorMap>
					</RasterSymbolizer>
				</Rule>
			</FeatureTypeStyle>
